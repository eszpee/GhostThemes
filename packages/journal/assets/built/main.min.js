                            ...
                            <div class="gh-featured-article-container">
                                <div class="gh-featured-content">
                                    <p class="gh-postlist-item">
                                        <a class="gh-postlist-title" href="${(e=o.items.shift()).link}">${e.title}</a>
                                    </p>
                                </div>
                            </div>
                            <div class="gh-article-excerpt-container">
                                <p class="gh-article-excerpt">${e.description}</p>
                            </div>
                        </div>
      `,n=o.items.map(e=>`
                        <p class="gh-postlist-item">
                            <a class="gh-postlist-title" href="${e.link}">${e.title}</a>
                        </p>
        `).join(""),document.getElementById("latest-posts").insertAdjacentHTML("afterbegin",t+n)):document.getElementById("latest-posts").textContent="No posts available."}catch(e){document.getElementById("latest-posts").textContent="Failed to load the latest posts.",console.error("Error fetching the RSS feed:",e)}};