                            ...
                            <div class="gh-featured-article-container">
                                <div class="gh-featured-content">
                                    <p class="gh-postlist-item">
                                        <a class="gh-postlist-title" href="${(t=r.items.shift()).link}">${t.title}</a>
                                    </p>
                                </div>
                            </div>
                            <div class="gh-article-excerpt-container">
                                <p class="gh-article-excerpt">${t.description}</p>
                            </div>
                        </div>
      `,o=r.items.map(e=>`
                        <p class="gh-postlist-item">
        ...
        `).join(""),document.getElementById("latest-posts").insertAdjacentHTML("afterbegin",n+o)):document.getElementById("latest-posts").textContent="No posts available."}catch(e){document.getElementById("latest-posts").textContent="Failed to load the latest posts.",console.error("Error fetching the RSS feed:",e)}};